...
Any user can convert a Lead into a Prospect. The system opens the **Target Prospect Form**, a multi-tab, structured form used to enrich, validate, and qualify the potential dealer before submission and approval.
...
**Target** indicates that the Prospect has been created but is not yet ready for final submission or approval. The prospect will still require BDM approval to proceed to the ready state.

### Post-Conversion Behavior

- Prospect now follows the Prospect lifecycle
- Additional data can be captured
- Prospect requires BDM approval to be ready
